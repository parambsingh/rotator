...
class CitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'state_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'state_id_2' => ['type' => 'index', 'columns' => ['state_id'], 'length' => []],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-09-15 06:40:57',
                'modified' => '2020-09-15 06:40:57',
            ],
        ];
        parent::init();
    }
