        ...
        <div class="row justify-content-center">
            <div class="col-sm-8 col-lg-5">
                ...
                <div class="u-shadow-v21 g-bg-white rounded g-py-40 g-px-30">
                    ...
                    <div id="setMessage">
                        <div class="mb-4">
                            <?= $this->Form->input('forgot_password_token', ['type'     => 'hidden',
                        ...
                        <div class="mb-4">
                            ...
                            <?= $this->Form->input('password', ['class'        => 'form-control g-color-black g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-brd-primary--hover rounded g-py-15 g-px-15',
                                                                'id'           => 'password',
                                                                'type'        => 'password',
                                                                'label'        => false,
                                                                'value'        => "",
                        ...
                        <div class="mb-4">
                            <label class="g-color-gray-dark-v2 g-font-weight-600 g-font-size-13">Confirm
                                Password:</label>
                            <?= $this->Form->input('Confirm Password', ['name'         => 'verify_password',
                                                                        'id'           => 'verifyPassword',
                        ...
                        <div class="mb-5">
                            ...
                            <div id="errorMsgSec" class="error" style="color:red;">
                            </div>
                            <div class="mb-4 mt-4">
                                <?= $this->Form->button(__('Submit'), ['id'    => 'resetPasswordBtn',
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.code == 200) {
                            ...
                            $('#errorMsgSec').html(response.message).fadeIn();
                            grecaptcha.reset();
                        }
                    },
                    complete: function () {
