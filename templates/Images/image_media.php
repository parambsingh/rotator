...
<script>
    $(function () {
        ...
        function getImages() {
            loadingData = true;
            $.ajax({
                url: SITE_URL + "images/getImages/" + loadPage,
                type: "POST",
                data: {
        ...
        function getUserImages() {
            loadingData = true;
            $.ajax({
                url: SITE_URL + "images/getUserImages/" + loadPage,
                type: "POST",
                data: {
                    model_id: $('#imageUserId').val(),
                    category: $('#imageCategory').val(),
