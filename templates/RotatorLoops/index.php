 ...
 * @var \App\Model\Entity\RotatorLoop[]|\Cake\Collection\CollectionInterface $rotatorLoops
 */
?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $rotatorLoop->has('lead') ? $this->Html->link($rotatorLoop->lead->id, ['controller' => 'Leads', 'action' => 'view', $rotatorLoop->lead->id]) : '' ?></td>
