<header id="js-header"
    ...
    <div class="u-header__section u-header__section--admin-dark g-bg-black-opacity-0_9 g-transition-0_3 g-py-15"
        ...
        <div class="container">
            ...
            <span class="hamburger-box">
              <span class="hamburger-inner"></span>
                ...
                <!-- Logo -->
                <a href="<?= SITE_URL ?>" class="navbar-brand py-5">
                    <?= $this->Html->image('logo.png', ['alt' => SITE_TITLE, 'height'=>'60px']); ?>
                </a>
                <!-- End Logo -->
