...
class ThumbComponent extends Component {
    ...
    public function create($attr = array()) {
        ...
        if ($imageCrop) {
            imagecopyresampled($tmp_img, $img, 0, 0, $imageX, $imageY, $new_width, $new_height, $new_width, $new_height);
            //resize the image
        } else {
            imagecopyresampled($tmp_img, $img, 0, 0, $imageX, $imageY, $new_width, $new_height, $width, $height);
            //resize the image
        }
