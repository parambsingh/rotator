...
function searchResults() {
    $.ajax({
        url: SITE_URL + "admin/companies/getApartmentList/",
        type: "post",
                ...
                if (resp.data.apartments.length > 0) {
                    ...
                    $.each(resp.data.apartments, function (index, apt) {
                        ...
                        var apartment = {
                            ...
                            image: image,
                            user: apt.user.first_name+" "+apt.user.last_name,
                            phone: apt.user.phone,
                            email: apt.user.email,
                            no_of_units: apt.no_of_units,
                            year_built_in: apt.year_built_in,
                            lat: apt.lat,
                            lng: apt.lng,
...
function showApartmentDetails(id) {
    ...
    $.ajax({
        url: SITE_URL + 'admin/companies/apartmentProfile',
        type: "post",
        data: {
            apartmentId: id,
