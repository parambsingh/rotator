  ...
  function AbstractDropdown(element, config) {
    ...
    this.smartPosition = function (target) {
      ...
      var $w = $(window),
        ...
        direction = Math.abs(parseInt(((typeof styles == "undefined" || styles == null) ? 0 : styles.left), 10)) < 40 ? 'left' : 'right',
      ...
      if (direction == 'right') {
        ...
        if (!target.data('baseDirection')) target.data('baseDirection', {
          direction: 'right',
          value: parseInt(((typeof styles == "undefined" || styles == null) ? 0 : styles.right), 10)
        });
        ...
        if (!target.data('baseDirection')) target.data('baseDirection', {
          direction: 'left',
          value: parseInt(((typeof styles == "undefined" || styles == null) ? 0 : styles.left), 10)
        });
